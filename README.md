...
- 当你说 `123` 时，表示：先打包，然后更新 `README.md`，最后提交并推送
...
- [okx_quant/strategy_symbol_defaults.py](/D:/qqokx/okx_quant/strategy_symbol_defaults.py)：分币种策略默认模板，当前已固化 `v0.6.88` 的多头/空头独立参数
