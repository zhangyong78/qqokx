...
STRATEGY_UI_SCHEMAS: dict[str, StrategyUiSchema] = {
    ...
    STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID: StrategyUiSchema(
    ...
    STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID: StrategyUiSchema(
    ...
    STRATEGY_BTC_DAILY_4H_LONG_SHORT_ID: StrategyUiSchema(
