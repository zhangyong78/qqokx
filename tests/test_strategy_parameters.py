...
class StrategyParametersTest(TestCase):
    ...
    def test_ema55_slope_short_strategy_keeps_signal_fixed_but_allows_coin_specific_ma_params(self) -> None:
        ...
        self.assertIn("atr_take_multiplier", keys)
        self.assertIn("take_profit_mode", keys)
        self.assertIn("dynamic_two_r_break_even", keys)
        self.assertIn("dynamic_break_even_trigger_r", keys)
        self.assertIn("dynamic_fee_offset_enabled", keys)
        ...
        self.assertIn("dynamic_trailing_step_r", keys)
    ...
    def test_btc_ema55_slope_short_strategy_keeps_only_core_parameters(self) -> None:
        ...
        self.assertEqual(strategy_fixed_value(STRATEGY_BTC_EMA55_SLOPE_SHORT_ID, "ema_type"), "ema")
        self.assertEqual(strategy_fixed_value(STRATEGY_BTC_EMA55_SLOPE_SHORT_ID, "ema_period"), 55)
    ...
    def test_btc_ema15_ma50_pullback_profiles_share_same_research_parameter_set(self) -> None:
        ...
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "ema_type"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "ema_period"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "trend_ema_type"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "trend_ema_period"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID, "ema_type"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID, "ema_period"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID, "trend_ema_type"))
        self.assertIsNone(strategy_fixed_value(STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID, "trend_ema_period"))
        ...
        self.assertTrue(strategy_is_parameter_editable(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "ema_type", "backtest"))
        self.assertTrue(strategy_is_parameter_editable(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "ema_period", "backtest"))
        self.assertTrue(strategy_is_parameter_editable(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "trend_ema_type", "backtest"))
        self.assertTrue(strategy_is_parameter_editable(STRATEGY_BTC_EMA15_MA50_PULLBACK_LONG_ID, "trend_ema_period", "backtest"))
        self.assertTrue(strategy_is_parameter_editable(STRATEGY_BTC_EMA15_MA50_PULLBACK_SHORT_ID, "ema_type", "backtest"))
