...
PARAMETERS: dict[str, ParameterDefinition] = {
    ...
    "trend_ema_slope_filter_enabled": ParameterDefinition(key="trend_ema_slope_filter_enabled", default=True),
...
STRATEGY_PARAMETER_PROFILES: dict[str, StrategyParameterProfile] = {
    ...
    STRATEGY_BTC_DAILY_4H_LONG_SHORT_ID: StrategyParameterProfile(
